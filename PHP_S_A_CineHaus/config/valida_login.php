...
if(!empty($dados['bt_login'])){
    ...
    if ($_SESSION['nivel_acesso_id']=='1'){
        header("Location:\PHP_S_A_CineHaus\dashboard_user.php");
    ...
    $_SESSION['msg']="<p style = 'color:black'> Usuário Inválido! </p>";
    header("Location:../index.php");
}
    //(1) Vê se não veio dados do bt_login.
    }else{
    $_SESSION['msg']="<style='color:red'> Não recebi dados alguns. </p>";
    header("Location:../index.php");
